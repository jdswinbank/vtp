...
IVOID\footnote{International Virtual Observatory identifier;
\citet{std:VOID2}.} of the broker which is managing the connection. The
...
additional \xmlel{<Response~/>} element containing the IVOID of the
